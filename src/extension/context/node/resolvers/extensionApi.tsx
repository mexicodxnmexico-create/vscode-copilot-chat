...
export class VSCodeAPIContextElement extends PromptElement<VSCodeAPIContextProps> {
	...
	override async render(
		...
		if (snippets.length) {
			return (
				<>
					Below are some potentially relevant code samples related to<br />
					VS Code extension development. You may use information from<br />
					these samples to help you answer the question if you believe<br />
					it is relevant.<br />
					<br />
					{snippets.map((s) => {
						return (
