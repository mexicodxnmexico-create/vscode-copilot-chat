		...
		return (
			<InstructionMessage>
				...
				<Tag name="user_updates_spec">
					...
					<br />
					<br />
					Ensure all your intermediary updates are shared in<br />
					`commentary` channel in between `analysis` messages or tool<br />
					calls, and not just in the final answer.<br />
					<br />
					Tone:
					<br />
