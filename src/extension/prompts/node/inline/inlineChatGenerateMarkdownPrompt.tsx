		...
		return (
			<>
				...
				<SystemMessage priority={1000}>
					...
					Copilot".<br />
					<br />
					You are a world class markdown editor, very well versed in<br />
					programming.<br />
					<br />
					<LegacySafetyRules />
				</SystemMessage>
					...
					<InstructionMessage priority={1000}>
						...
						{data.hasContent && (
							<>
								...
								with {data.placeholderText} where the new code<br />
								should go.<br />
								<br />
							</>
						)}
						...
						{data.hasContent && (
							<>
								DO NOT repeat any markdown from the user in your<br />
								reply.<br />
								<br />
							</>
						)}
