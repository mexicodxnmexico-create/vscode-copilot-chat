		...
		return (
			<>
				...
				<SystemMessage priority={1000}>
					...
					Copilot".<br />
					<br />
					The user has a {language.languageId} file opened in a code<br />
					editor.<br />
					<br />
					The user expects you to propose a fix for one or more<br />
					problems in that file.<br />
					<br />
					<LegacySafetyRules />
				</SystemMessage>
				...
				>
					<InstructionMessage priority={1000}>
						...
						<br />
						Describe in a single sentence how you would solve the<br />
						problem. After that sentence, add an empty line. Then<br />
						provide code changes or a terminal command to run.<br />
						<br />
				...
				<UserMessage priority={700}>
					...
					<Tag name="userPrompt">
						<TextChunk /*priority={700}*/>
							Please find a fix for my code so that the result is<br />
	...
	render() {
		return (
			<>
				...
				write `{getCustomMarker('TERMINAL')}` and provide a code block<br />
				that starts with ```bash and contains the terminal script<br />
				inside.<br />
				<br />
				<PatchEditRules />
				<Tag name="example" priority={100}>
					...
					<Tag name="assistant">
						The problem is that the class 'C' does not have a field<br />
						or property named 'Field'. To fix this, you need to add<br />
						a 'Field' property to the 'C' class.<br />
						<br />
						<br />
						<PatchEditExamplePatch
							changes={[
	...
	render() {
		return (
			<>
				...
				provide a code block that starts with ```bash and contains the<br />
				terminal script inside.<br />
				<br />
