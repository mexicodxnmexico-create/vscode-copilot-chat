			...
			<>
				...
				>
					<InstructionMessage priority={priorities.core}>
						{jupyterNotebook && (
							<>
								...
								{!tagBasedDocumentSummary && (
									<>
										When dealing with Jupyter Notebook, do<br />
										not generate CELL INDEX in the code<br />
										blocks in your answer, it is only used<br />
						...
						{hasContent && (
							<>
								The user includes existing code and marks with<br />
								$PLACEHOLDER$ where the new code should go.<br />
								<br />
							</>
						)}
						{hasContent && (
							<>
								DO NOT include the text "$PLACEHOLDER$" in your<br />
								reply.<br />
								<br />
							</>
						)}
						{hasContent && (
							<>
								DO NOT repeat any code from the user in your<br />
								reply.<br />
								<br />
							</>
						)}
						{!hasContent && extractCodeBlock && (
							<>
								Your must generate a code block surrounded with<br />
								``` that will be used in a new file<br />
								<br />
							</>
						)}
						{!extractCodeBlock && (
							<>
								When generating content for markdown cell,<br />
								provide the answer directly without any<br />
								additional introductory text. Ensure that the<br />
								response is structured in Markdown format to<br />
								seamlessly integrate into the markdown file.<br />
							</>
						)}
					</InstructionMessage>
				</HistoryWithInstructions>
				...
				<UserMessage priority={priorities.core}>
					...
					{hasContent && extractCodeBlock && (
						<>
							The code that would fit at $PLACEHOLDER$ with ```<br />
							is:<br />
						</>
					)}
					{hasContent && !extractCodeBlock && (
						<>
							The code that would fit at $PLACEHOLDER$ without ```<br />
							is:<br />
						</>
					)}
				</UserMessage>
						...
						<UserMessage>
							{isMarkdown ? (
								<>
									...
									{!hasContent && (
										<>
											Now I create a new markdown cell in<br />
											this Jupyter Notebook document at<br />
											index {aboveCellsInfo.length}.<br />
										</>
									)}
									This is a markdown cell. Markdown cell is<br />
									used to describe and document your workflow.<br />
									<br />
									{hasContent && (
										<>
											<CodeBlock
							...
							{isMarkdown ? (
								<>
									...
									{!hasContent && (
										<>
											Now I create a new markdown cell in<br />
											this custom Notebook document at<br />
											index {aboveCellsInfo.length}.<br />
										</>
									)}
									This is a markdown cell. Markdown cell is<br />
			...
			<>
				{
					<UserMessage>
						...
						respond with. Please follow the exmaples on how to avoid<br />
						repeating code.<br />
						<br />
						...
						'Charlie'], 'Age': [25, 30, 35], 'Gender': ['F',<br /> 'M',
						'<br />M']&#125;)
						<br />
						print(df)
						<br />
						...
						---------------------------------
						<br />
						To plot the dataframe, we can use the `plot()` method of<br />
						pandas dataframe. Here's the code:<br />
						<br />
						<br />
						```python
						<br />
