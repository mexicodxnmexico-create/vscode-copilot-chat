				...
				{(aboveCellsInfo.length > 0 || belowCellsInfo.length > 0) && (
					<UserMessage>
						...
						<>
							...
							<br />
							In this new cell, I am working with the following<br />
							code:<br />
							<br />
							```python
							<br />
							...
							method of pandas dataframe. Here's the code:<br />
							<br />
							<br />
							```python
							<br />
			...
			<>
				{(aboveCellsInfo.length > 0 || belowCellsInfo.length > 0) && (
					<UserMessage>
						...
						<Tag name="example">
							<Tag name="cellsAbove">
								Here are the cells above the current cell that I<br />
								am editing in this Jupyter Notebook:<br />
								<br />
								<IndexedTag name="cell" index={0}>
									<TextChunk>
										...
										# create a dataframe with sample data
										<br />
										df = pd.DataFrame(&#123;'N<br />ame':
										['Alice', 'Bob', 'Charlie'], 'Age':<br /> [25,
										30, 35], 'Gender': ['F',<br /> 'M',
										'<br />M']&#125;)
										<br />
										print(df)
						...
						{belowCellsInfo.length > 0 && (
							<Tag name="cellsBelow">
								Here are the cells below the current cell that I<br />
								am editing in this Jupyter Notebook:<br />
								<br />
	...
	render(state: void, sizing: PromptSizing) {
		...
		return (
			<>
				{
					<UserMessage>
						I am working on a {notebookTypeName} notebook in VS<br />
						Code.<br />
						<br />
						{notebookTypeName} notebooks in VS Code are documents<br />
						that contain a mix of rich Markdown, executable code<br />
						snippets, <br />
						and accompanying rich output. These are all separated
						into distinct cells and can be interleaved in any order{' '}
						<br />A {notebookTypeName} notebook contains multiple<br />
						cells.<br />
						<br />
					</UserMessage>
				}
				...
				{state.variables.length !== 0 && (
					<>
						<UserMessage priority={priorities.runtimeCore}>
							The following variables are present in this Jupyter<br />
							Notebook:<br />
				...
				{state.packages.length !== 0 && (
					<>
						<UserMessage priority={priorities.other}>
							The following pip packages are available in this<br />
							Jupyter Notebook:<br />
