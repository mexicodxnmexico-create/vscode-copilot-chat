	...
	async render(_state: void, _sizing: PromptSizing) {
		return (
			<>
				...
				<br />
				1. Each cell must be wrapped in a {'<VSCode.Cell>'} with a<br />
				`language` attribute indicating the type of content. (e.g.,<br />
				`markdown`, `python`). <br />
	...
	async render(_state: void, _sizing: PromptSizing) {
		return (
			<>
				...
				<br />
				1. Each cell must begin with a comment beginning with `#%%<br />
				vscode.cell` followed by the cell attributes.<br />
				<br />
				2. For existing cell in the document, use the `id` attribute to<br />
				identify the cell. If the cell is new, DO NOT include the `id`<br />
				attribute.<br />
				<br />
