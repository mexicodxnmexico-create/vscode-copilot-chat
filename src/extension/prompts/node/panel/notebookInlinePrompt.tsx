		...
		const instructions = (
			<InstructionMessage priority={900}>
				<Tag name="instructions">
					...
					user asked for it. Use the {ToolName.EditNotebook} tool<br />
					instead.<br />
					<br />
					Do not summarize the changes after making the edits and<br />
					leave the response empty if there is nothing more to add.<br />
					<br />
				...
				<Tag name="toolUseInstructions">
					...
					of saying that you'll use the {ToolName.EditNotebook} tool,<br />
					say "I'll edit the project.js file".<br />
					<br />
				</Tag>
