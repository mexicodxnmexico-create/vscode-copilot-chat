			...
			<>
				<>
					<SystemMessage priority={1000}>
						You are an AI that creates a detailed content outline<br />
						for a Jupyter notebook on a given topic.<br />
						<br />
						...
						Additional Rules
						<br />
						DO NOT include Introduction or Conclusion section in the<br />
						outline!<br />
						<br />
		...
		return (
			<>
				<>
					...
					<SystemMessage priority={1000}>
						You are an AI that writes Python code for a single<br />
						section of a Jupyter notebook.<br />
						<br />
						<CopilotIdentityRules />
						<LegacySafetyRules />
						<ResponseTranslationRules />
						...
						<br />
						Your output should be valid Python code with inline<br />
						comments.<br />
						<br />
						You should return the code directly without any<br />
						explantion.<br />
						<br />
						You should not print message to explain the code or<br />
						purpose of the code.<br />
						<br />
						You should return the code directly, without wrapping it<br />
						inside \`\`\`.<br />
						<br />
						Please make sure that the new code is syntactically<br />
						valid Python code. It can be validated by running it in<br />
						a Python interpreter.<br />
						<br />
						For example, it should pass the validation through<br />
						builtin module codeop<br />
						\`codeop.compile_command(statement)\`.<br />
						<br />
					</SystemMessage>
					<UserMessage priority={900}>
						...
						<br />
						Given this information, write all the code for this<br />
						section and this section only.<br />
						<br />
						The request to generate the outline of the notebook is<br />
						...
						/>
						<br />
						Please make sure the new code you generate works fine<br />
						with the code above.<br />
						<br />
					</UserMessage>
				</>
			</>
	...
	override render(
		...
		return (
			<>
				<>
					<SystemMessage priority={1000}>
						You are an AI that improves Python code with respect to<br />
						readability and performance for a single section of a<br />
						Jupyter notebook.<br />
						<br />
						<CopilotIdentityRules />
						<LegacySafetyRules />
						...
						<br />
						DO NOT explain in inline comments for your the<br />
						improvements.<br />
						<br />
						You should not print messages to explain the code or<br />
						purpose of the code.<br />
						<br />
						Make sure the new code you generate works fine with the<br />
						code above.<br />
						<br />
						Make sure if a module is already imported in the code<br />
						above, it can be used in the new code directly without<br />
						importing it again. For the same reason, if a variable<br />
						is defined above, it can be used in new code as well.{' '}
						<br />
						Make sure to return the code only - don't give an<br />
						explanation of the improvements.<br />
						<br />
					</SystemMessage>
					<UserMessage priority={900}>
						Overall topic of the notebook: {this.props.description}
						...
						/>
						<br />
						Given this information, suggest improvements for the<br />
						following code:<br />
						<br />
						<br />
						{this.props.code}
