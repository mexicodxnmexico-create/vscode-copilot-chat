...
export class EditFileResult extends PromptElement<IEditFileResultProps> {
	...
	override async render(state: void, sizing: PromptSizing) {
		...
		return (
			...
			>
				Below is a summary of some of the inserted cells including some<br />
				of the existing cells around the new cells.<br />
				<br />
				NOTE: This is merely a summary and not the actual content of the<br />
				cells nor the entire notebook.<br />
				<br />
				<CodeBlock
