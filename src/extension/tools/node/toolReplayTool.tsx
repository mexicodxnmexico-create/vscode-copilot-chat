...
export class ToolReplayTool implements LanguageModelTool<ToolReplayParams> {
	...
	invoke(
		options: LanguageModelToolInvocationOptions<ToolReplayParams>,
		...
		return new LanguageModelToolResult(
			toolResults.map((result) => new LanguageModelTextPart(result)),
		);
	}

	prepareInvocation(
		options: LanguageModelToolInvocationPrepareOptions<ToolReplayParams>,
		token: CancellationToken,
