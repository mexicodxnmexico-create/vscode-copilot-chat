...
export class GetWorkspaceSetupInfoTool implements ICopilotTool<IWorkspaceSetupInfoToolParams> {
	...
	async invoke(
		...
		const selectedSetupInfo = setupInfo.find(
			(info) => info.projectType === projectType,
		);
...
export class WorkspaceSetupResult extends PromptElement<WorkspaceSetupProps> {
	...
	override async render(state: void, sizing: PromptSizing) {
		const useContext7 = this.configurationService.getConfig(
			ConfigKey.NewWorkspaceUseContext7,
		);
		if (useContext7) {
			return (
				<>
					{' '}
					<TextChunk>
						Use context7 tools to find the latest libraries, APIs,<br />
						and documentation to help the user create and customize<br />
						their project.<br />
						<br />
						1. Call mcp_context7_resolve-library-id with your<br />
						project requirements.<br />
						<br />
						2. Call mcp_context7_get-library-docs to get scaffolding<br />
						instructions.<br />
						<br />
						You must call these tools before proceeding and confirm<br />
						that you did NOT skip this step.<br />
						<br />
						<br />
					</TextChunk>
				</>
