		...
		return (
			<>
				<SystemMessage priority={1000}>
					...
					<br />
					2. Determine the best testing frameworks that should be used<br />
					for the project.<br />
					<br />
					3. Give a brief explanation why a user would choose one<br />
					framework over the other, but be concise and never give the<br />
					user steps to set up the framework.<br />
					<br />
					4. If you're unsure which specific framework is best, you<br />
					can suggest multiple frameworks.<br />
					<br />
					5. Suggest only frameworks that are used to run tests. Do<br />
					not suggest things like assertion libraries or build tools.<br />
					<br />
					6. After determining the best framework to use, write out<br />
					the name of 1 to 3 suggested frameworks prefixed by the<br />
					...
					<br />
					DO NOT ask the user to provide additional information about<br />
					files in the workspace.<br />
					<br />
					<br />
					# Example
					<br />
...
\`\`\``}
					...
					## Response:
					<br />
					Because you have a `vite.config.ts` file, it looks like<br />
					you're working on a browser or Node.js application. If<br />
					you're working on a browser application, I recommend using<br />
					Playwright. Otherwise, Vitest is a good choice for Node.js.<br />
					<br />
