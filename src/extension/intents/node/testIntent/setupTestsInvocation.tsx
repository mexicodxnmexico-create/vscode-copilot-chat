		...
		return (
			<>
				<SystemMessage priority={1000}>
					You are a software engineer with expert knowledge around<br />
					software testing frameworks.<br />
					<br />
					<br />
					...
					# Additional Rules
					<br />
					1. The user will tell you what testing framework they want<br />
					to set up, and provide you their workspace structure.<br />
					<br />
					2. Determine how to test up the desired testing framework.
					<br />
					3. Generate a markdown file tree structure listing files you<br />
					want to create or edit in order to set up the testing<br />
					framework. The tree MUST NOT include files that don't need<br />
					to be modified.<br />
					<br />
					4. Make sure to include a basic "hello world" test to help<br />
					the user get started. If you see existing test files in the<br />
					workspace, make sure to try to match their naming<br />
					convention.<br />
					<br />
					5. Do not attempt to modify the file content yourself and<br />
					simply respond with the file tree structure.<br />
					<br />
					6. After listing the file tree structure, respond with any<br />
					terminal commands the user should execute to finish<br />
					installing the testing framework. Terminal commands should<br />
					be wrapped in a code fence tagged with the "sh" language.<br />
					<br />
					7. Finally, provide a command line a user can execute to run<br />
					their tests.<br />
					<br />
					{setupConfirmation && (
						<>
							8. At the end, include a phrase that conveys '
							{setupConfirmation.message}', but rephrase this to<br />
							indicate that this is the last step the user needs<br />
							to take to enable rich UI integration in VS Code.<br />
					...
					<br />
					I am working in a workspace that has the following<br />
					structure:<br />
					<br />
					{`\`\`\`
src/
...
\`\`\``}
					...
					## Response:
					<br />
					Let's create a `.mocharc.js` file to configure your test<br />
					settings, as well as a "hello world" test:<br />
					<br />
					<br />
					{`\`\`\`filetree
${projectNameToken}
		...
		return (
			<>
				<InstructionMessage priority={1000}>
					# Rules:
					<br />
					1. The user will give you instructions they were told<br />
					regarding how to set up a testing framework.<br />
					<br />
					2. Your job is to print the name of the testing framework<br />
					referred to in the response.<br />
					<br />
					3. Do not print any other information except for the name of<br />
					the framework.<br />
					<br />
					<br />
					# Example
					...
					## Question:
					<br />
					Given the structure of your workspace, I recommend using<br />
					Mocha for testing. To set up Mocha, you should create a<br />
					`.mocharc.js` file to configure your test settings, as well<br />
					as a "hello world" test.<br />
					<br />
					## Response:
					<br />
					mocha
