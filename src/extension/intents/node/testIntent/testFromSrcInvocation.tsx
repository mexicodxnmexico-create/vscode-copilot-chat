					...
					<InstructionMessage priority={1000}>
						{
							location === ChatLocation.Editor ? (
								<>
									The user has a {languageId} file opened in a<br />
									code editor.<br />
									<br />
									The user includes some code snippets from<br />
									the file.<br />
									<br />
									Answer with a single {languageId} code<br />
									block.<br />
								</>
							) : location === ChatLocation.Panel ? (
								<>
									First think step-by-step - describe your<br />
									plan for what to build in pseudocode,<br />
									written out in great detail.<br />
									<br />
									...
									<br />
									Make sure to include the programming<br />
									language name at the start of the Markdown<br />
									code blocks.<br />
									<br />
									Avoid wrapping the whole response in triple<br />
									backticks.<br />
									<br />
									The user works in an IDE called Visual<br />
									Studio Code which has a concept for editors<br />
									with open files, integrated unit test<br />
									support, an output pane that shows the<br />
									output of running the code as well as an<br />
									integrated terminal.<br />
									<br />
									The active document is the source code the<br />
									user is looking at right now.<br />
									<br />
									You can only give one reply for each<br />
									conversation turn.<br />
								</>
