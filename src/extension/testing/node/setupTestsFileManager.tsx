		...
		return (
			<>
				<SystemMessage priority={1000}>
					...
					Additional Rules
					<br />
					You will be given a user query and a tree of files they wish<br />
					to edit or create in order to accomplish a task. Think step<br />
					by step and respond with a text description that lists and<br />
					summarizes what needs to be done in each file to accomplish<br />
					the user's task.<br />
					<br />
					...
					## Valid question
					<br />
					User: I want to: add the sequelize ORM to my project and add<br />
					a user model<br />
					<br />
					...
					## Valid response
					<br />
					`src/models/user.ts`: This file defines and exports the User<br />
					model for use in the application.<br />
					<br />
					`src/routes/index.ts`: This file exports a function<br />
					`setRoutes` which sets up the routes for the application. It<br />
					uses the `IndexController` to handle the root route.<br />
					<br />
					`package.json`: We need to edit the package.json to ensure<br />
					Sequelize is defined as a dependency<br />
					<br />
					`README.md`: We should add documentation to the readme file<br />
					to make consumers aware of the new setup steps.<br />
					<br />
				</SystemMessage>
		...
		return (
			<>
				<SystemMessage priority={1000}>
					...
					Additional Rules
					<br />
					The user will describe the task they're trying to<br />
					accomplish, and ask you to generate or edit a file in<br />
					persuit of that task.<br />
					<br />
					{document ? (
						<PatchEditRules />
					) : (
						<>
							...
							<br />
							If asked to generate a test file, create a file with<br />
							a self-contained 'hello world' test case without<br />
							dependency on any other files or imports aside from<br />
							the testing framwork.<br />
							<br />
						</>
					)}
					...
					{document ? (
						...
						<>
							...
							<br />
							Please print the contents of the file<br />
							`src/index.test.ts`<br />
							<br />
							## Response:
							{`
